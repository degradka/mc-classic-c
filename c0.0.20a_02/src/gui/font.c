    ...
    for (int i = 0; i < 256; ++i) {
        ...
        for (; x < 8 && !emptyColumn; ++x) {
            ...
            for (int y = 0; y < 8 && emptyColumn; ++y) {
                ...
                // pixel's blue channel exceeds 128, not alpha. These agree
                // for the old default.gif (transparent background happens
                // to also be zero blue) but not for default.png, whose
                // background is opaque, which is what broke this
