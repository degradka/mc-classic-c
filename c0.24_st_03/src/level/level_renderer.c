...
// GL_DST_COLOR/GL_SRC_COLOR blend real source uses so it darkens rather than
// tints. This was entirely missing, since the progressive mining tracker
// driving it (see updateMining in minecraft.c) didn't exist either
