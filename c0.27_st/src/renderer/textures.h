...
// c0.27_st: Font's own live per-glyph color-code remap (new this version,
// see font.c) reads the current setting through this getter rather than
// caching its own copy, so it always reflects the latest Options toggle
bool Textures_isAnaglyph(void);
